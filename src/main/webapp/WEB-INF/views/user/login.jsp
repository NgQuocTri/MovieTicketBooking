	...
	<div class="login-html">
		...
		<div class="login-form">
			...
			<div>
				...
				<a class="btn btn-primary" href="${registerUrl}" role="button">Đăng kí tài khoản</a>
				<div class="hr"></div>
				</form>
			</div>
			<div class="for-pwd-htm">
				...
				<form class="form-signin" method="post" action="${pageContext.request.contextPath}/resetPassword">
				<div>
