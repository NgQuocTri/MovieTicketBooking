...
<body>
	...
	<h3><b>Phim trong ngày</b></h3>
	<br>
	<c:if test="${empty todayMovies}">
		<h4>Không tìm thấy phim tương ứng</h4>
	</c:if>
	<div class="row">
		<c:forEach items="${todayMovies}" var="movie">
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="card h-100">
					<a href="<c:url value="${pageContext.request.contextPath}/home/movie?movieId=${movie.movieId}"/>">
						<img class="card-img-top" src='<c:url value="/uploads/moviePoster/${movie.imageName}"></c:url>' alt="">
					</a>
					<div class="card-body">
						<h4 class="card-title">
							Tên phim: <a href="${pageContext.request.contextPath}/home/movie?movieId=${movie.movieId}">${movie.movieName}</a>
						</h4>
	...
	<br>
	<h3><b>Phim sắp chiếu</b></h3>
	<br>
	<c:if test="${empty unfinishedMovies}">
		<h4>Không tìm thấy phim tương ứng</h4>
	</c:if>
	
    <div class="row">
		<c:forEach items="${unfinishedMovies}" var="movie">
			<div class="col-lg-4 col-md-6 mb-4">
				<div class="card h-100">
